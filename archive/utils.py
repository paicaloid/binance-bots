...
def msg_to_dataframe(info: dict, interval: str, tz: pytz.timezone) -> pd.DataFrame:
...
def get_historical_data(
    ...
    date_now = datetime.now(tz=pytz.timezone('Asia/Bangkok')).replace(second=0, microsecond=0)
    if interval == '1m':
